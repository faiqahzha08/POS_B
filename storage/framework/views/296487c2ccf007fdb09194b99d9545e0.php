            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-8">
                    ...
                    <div class="hidden md:flex items-center gap-1">
                        ...
                        class="px-3.5 py-2 rounded-lg text-sm font-medium transition
                        <?php echo e(request()->is('tentang-aplikasi*') ? 'text-indigo-600 bg-indigo-50' : 'text-slate-600 hover:bg-slate-100'); ?>">
...
</html><?php /**PATH C:\laragon\www\POS_0\resources\views/layouts/app.blade.php ENDPATH**/ ?>